                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @if (Auth::check())
                        <ul class="nav nav-underline">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('data-mahasiswa') ? 'active' : '' }}"
                                    href="{{ route('data-mahasiswa') }}">{{ __('Data Mahasiswa') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('jadwal-kuliah') ? 'active' : '' }}"
                                    href="{{ route('jadwal-kuliah') }}">{{ __('Jadwal Perkuliahan') }}</a>
                            </li>
                        </ul>
                    @endif
